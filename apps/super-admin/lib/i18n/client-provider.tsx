 ...
 * the top-nav EN|FR toggle can call `i18n.changeLanguage()` and get an
...
export function I18nClientProvider({
  ...
  // language changes go through `i18n.changeLanguage()` (nav toggle), not
  // by recreating the instance on every re-render.
  const i18n = useMemo(() => {
